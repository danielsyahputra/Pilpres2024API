...
def NotFound(detail: str = "Not Found") -> HTTPException:
    """
...
def InternalServerError(detail: str = "Internal Server Error") -> HTTPException:
    """
...
def UnprocessableEntity(detail: str = "Unprocessable Entity") -> HTTPException:
    """
...
def TooManyRequests(detail: str = "Too Many Requests") -> HTTPException:
    """
...
def ServiceUnavailable(detail: str = "Service Unavailable") -> HTTPException:
    """
...
def NotImplemented(detail: str = "Not Implemented") -> HTTPException:
    """
...
def BadGateway(detail: str = "Bad Gateway") -> HTTPException:
    """
...
def GatewayTimeout(detail: str = "Gateway Timeout") -> HTTPException:
    """
...
def MethodNotAllowed(detail: str = "Method Not Allowed") -> HTTPException:
    """
